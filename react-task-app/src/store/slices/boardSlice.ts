...
const boardsSlice = createSlice({
  name: "board",
  initialState,
  reducers: { // state => 이전에 가지고 있는 state
...
export const {sort, deleteBoard, addBoard, deleteList, deleteTask, updateTask, setModalActive, addTask, addList} = boardsSlice.actions;
